                                    ...
                                    <div class="flex flex-col justify-center items-center">
                                        <div class="relative">
                                            ...
                                            <div class="absolute left-0 top-0">
                                                <input type="file" accept=".jpeg, .png, .jpg" class="absolute h-40 w-40" style="opacity: 0;" @change="uploadEmployeePhoto">
                                            </div>
    ...
    methods: {
        submit(){
            ...
            if(this.password === '') {
                ...
                axios.post('/api/user/employees', data)
                    .then(response => {
                        this.handleClose();
                        this.handleReload();
                        this.successToast('New employee has been added successfully!')
                    })
                    .catch(error => {
