...
export default {
    ...
    setup(props) {
        ...
        function getCategory(){
            axios.get('/api/user/product_categories/' + props.category)
            .then(({data}) => {
    ...
    methods: {
        update(){
            ...
            axios.put('/api/user/product_categories/' + this.category, data)
                .then( response => {
                    this.handleReload()
                    this.handleClose()
                    this.successToast('Category has been updated!')
                })
        },
        handleClose() {
            this.$emit('close')
