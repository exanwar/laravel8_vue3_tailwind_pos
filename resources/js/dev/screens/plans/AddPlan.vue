                                ...
                                <div class="flex flex-col space-y-1.5">
                                    ...
                                    <input
                                        ...
                                        class="
                                            ...
                                            text-sm
                                        "
                                        v-model.number="addPlanDiscount"
                                    />
                                </div>
                                <div class="flex flex-col space-y-1.5">
                                    <h1
...
export default {
    setup(){
        const addPlanName = ref(null)
        const addPlanMonthly = ref(null)
        const addPlanDiscount = ref(null)
        const addPlanYearly = computed(() => {
            let monthly = Number.parseFloat(addPlanMonthly.value)
            let discount = Number.parseFloat(addPlanDiscount.value)
