                ...
                <div class="grid grid-cols-1 gap-6">
                    <div class="bg-white rounded-lg overflow-hidden">
                        ...
                        >
                            ...
                            <button class="blue-button text-xs font-semibold" @click="addPermissionModal = true">
                                <i class="fas fa-plus"></i><span> Add Permission</span>
                            </button>
                        </div>
                            ...
                            <div class="bg-white shadow-md rounded my-6">
                                <table class="w-full table-auto">
                                    ...
                                    <tr
                                        ...
                                        hover:bg-blue-100                                   "
                                    >
                                        <td class="px-6 py-3 text-gray-600 font-lg font-semibold text-center">{{ permission.title }}</td>
                                        ...
                                        <td class="py-3 px-6 text-center">
                                            ...
                                            >
                                                <button
                                                    ...
                                                    @click.prevent="openEditModal(permission.id)"
...
export default {
    components:{SearchIcon, AddPermission, EditPermission},
    setup() {
        ...
        function searchIt(){
            if(query.value !== '') {
                axios.get('/api/dev/find-permission?q=' + this.query)
                    .then( ({data}) => {
                        permissions.value = data.data
                    })
                    .catch(error => {
        ...
        function deletePermission(id){
            InjectDirectly.fire({
                ...
                if (result.isConfirmed) {
                    axios.delete('/api/dev/permissions/' + id)
                        .then( response => {
                            getPermissions()
